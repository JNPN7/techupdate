							...
							<div class="col">
								...
								?>			
											<div class="post post-col">
												...
												?>
												<a class="post-img col-img" href="blog?id=<?php echo $blog->id ?>"><img class="post-thumb" src="<?php echo $thumbnail ?>" alt="Snow" style="width:100%; min-height: 13vw"></a>
												<div class="meta-col">
													...
													<div class="post-des"><?php echo html_entity_decode(substr(explode('#end#', $blog->content)[0], 25, 325).'.......') ?><a href="blog?id=<?php echo $blog->id ?>">Show More</a></div>
												</div>
											</div>
